...
class DatabaseTimeLoggingTestEnableDataDisable {
    ...
    @Test
    public void TestTimeLoggingEnableButDataDisableDatabaseRetrieveOne() {
    ...
    @Test
    public void TestTimeLoggingEnableButDataDisableDatabaseRetrieveAll() {
