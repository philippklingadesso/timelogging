...
@SpringBootTest(
        properties = {
                ...
                "com.adesso.utils.timelogging.data=false"
        })
...
class DatabaseTimeLoggingTestEnableRepositoryAndDataDisable {
    ...
    @Test
    public void TestTimeLoggingEnableButRepositoryAndDataDisableDatabaseRetrieveOne() {
    ...
    @Test
    public void TestTimeLoggingEnableButRepositoryAndDataDisableDatabaseRetrieveAll() {
