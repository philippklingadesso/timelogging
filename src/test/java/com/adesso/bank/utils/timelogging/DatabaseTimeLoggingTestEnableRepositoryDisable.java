...
@SpringBootTest(
        properties = {
                ...
                "com.adesso.utils.timelogging.repository=false"
        })
...
class DatabaseTimeLoggingTestEnableRepositoryDisable {
    ...
    @Test
    public void TestTimeLoggingEnableButRepositoryDisableDatabaseRetrieveOne() {
        String expected = "data1";

        String result = testService.retrieveOne();

        // I look for a specific message at a specific level, and I only have 2
        assertThat(memoryAppender.search(MSG, loggingLevel).size()).isEqualTo(2);
    ...
    @Test
    public void TestTimeLoggingEnableButRepositoryDisableDatabaseRetrieveAll() {
